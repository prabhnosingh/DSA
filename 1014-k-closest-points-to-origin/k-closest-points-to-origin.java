...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // //TC: O(nlogk + nlogk + nlogk) = O(nlogk)  where n is the number of points 
    // public int[][] kClosest(int[][] points, int k) {
    ...
    //         maxHeap.offer(point); //O(nlogk)
            
    //         if(maxHeap.size() > k) maxHeap.remove(); //to keept the size upto k only //O(nlogk)
    //     }
        

    //     while(!maxHeap.isEmpty()){ 
    //         int[] currPoint = maxHeap.remove(); //O(nlogk)
